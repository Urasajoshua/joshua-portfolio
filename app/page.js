        ...
        <div className='px-2'>
          <form className='border rounded-2xl md:px-8 md:py-8'>
            ...
            <div className='flex flex-col px-4 md:py-4'>
              ...
              <input placeholder='joshua' type='text' className='py-3 rounded-2xl border px-6' />
            </div>
            ...
            <div className='flex flex-col px-4 md:py-4'>
              ...
              <input placeholder='urasa' type='text' className='py-3 rounded-2xl border px-6' />
            </div>
            ...
            <div className='flex flex-col px-4 md:py-4'>
              ...
              <input placeholder='urasajoshuag@gmail.com' type='email' className='py-3 rounded-2xl border px-6' />
            </div>
            <div className='flex flex-col px-4 md:py-4'>
            ...
            <div className='flex flex-col px-4 md:py-4'>
              ...
              <textarea className='py03 px-6 rounded-2xl'>write your subject</textarea>
            </div>
            </div>
